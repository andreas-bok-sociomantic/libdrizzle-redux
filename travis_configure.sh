...
#
# If the upload succeeds the function exits with 0
# otherwise 1
#
# $1 path to coverage file generated by lcov
upload_coverage()
{
    sudo ln -sf $PWD /home/libdrizzle-redux
    echo "PWD: ";  ls -sf ./;
    echo "/home/libdrizzle-redux: "; ls -la /home/libdrizzle-redux;
